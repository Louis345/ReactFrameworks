...
```bash
git clone  https://github.com/YOUR-USERNAME/ReactFrameworks.git
```
...
```bash
cd
git remote add upstream https://github.com/Louis345/ReactFrameworks.git
git remote -v
# You should see your upstream set as https://github.com/Louis345/ReactFrameworks.git
